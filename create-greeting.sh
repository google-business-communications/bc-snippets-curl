...
# Replace the __BRAND_ID__ and __AGENT_ID__ with a brand ID and agent ID that
# you can create greetings for.

# Make sure a service account key file exists at ./service_account_key.json

curl -X POST "https://businesscommunications.googleapis.com/v1/brands/__BRAND_ID__/agents/__AGENT_ID__/greetings" \
