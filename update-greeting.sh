...
# Replace the __BRAND_ID__ and __AGENT_ID__ and __GREETING_ID__
# Make sure a service account key file exists at ./service_account_key.json

curl -X PATCH \
"https://businesscommunications.googleapis.com/v1/brands/__BRAND_ID__/agents/__AGENT_ID__/greetings/__GREETING_ID__?updateMask=welcomeMessages,customId" \
